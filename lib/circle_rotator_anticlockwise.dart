...
void render(Canvas canvas) {
  // Colored arcs are drawn by CircleArcAntiClockwise components
}
}
class CircleArcAntiClockwise extends PositionComponent with ParentIsA<Circle_rotator_anticlockwise>{
  final Color color;
  final double StartAngle;
  final double sweepAngle;
  CircleArcAntiClockwise({
    required this.color,
